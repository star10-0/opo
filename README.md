...
راجع الدليل التفصيلي: `docs/backup-and-restore.md`

## التحقق بعد النشر
1. تأكد من استجابة `GET /api/health`.
2. سجّل الدخول من الواجهة وتحقق من تحميل لوحة التحكم.
3. نفّذ عملية قراءة/إضافة بسيطة وتأكد من ظهور رسالة نجاح أو فشل واضحة.
4. راقب سجل الخادم للتأكد من عدم وجود أخطاء متكررة.
